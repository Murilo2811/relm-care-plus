...
import { Search, Plus, User as UserIcon, Shield, Lock, Power, Store as StoreIcon, AlertTriangle } from 'lucide-react';
...
const Users: React.FC<UsersProps> = ({ user }) => {
  ...
  const handleCreateUser = async (e: React.FormEvent) => {
      ...
      try {
          ...
          setNewUser({ name: '', email: '', role: Role.LOJA, storeId: '', active: true });
