...
const Login: React.FC<LoginProps> = ({ onLogin }) => {
  ...
  const fillDemo = (role: 'admin' | 'store') => {
    if (role === 'admin') {
      setEmail('admin@relm.com');
      setPassword('123456');
    } else {
      setEmail('loja@bikepoint.com');
      setPassword('123456');
    }
  };
          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-3 bg-white text-gray-400 font-medium">Preenchimento Rápido (Demo)</span>
              </div>
            </div>
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
               <button 
                  ...
                  className="w-full flex items-center justify-center px-4 py-2 border border-gray-200 shadow-sm text-xs font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 hover:border-gray-300 transition-all"
               >
                  Admin
               </button>
               <button 
